...
-- Past visits with time and vet assignment
INSERT INTO visits (pet_id, visit_date, description, start_time, duration_minutes, vet_id) SELECT 7, '2010-03-04', 'rabies shot', '09:30', 30, 1 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=1);
INSERT INTO visits (pet_id, visit_date, description, start_time, duration_minutes, vet_id) SELECT 8, '2011-03-04', 'rabies shot', '10:00', 30, 2 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=2);
INSERT INTO visits (pet_id, visit_date, description, start_time, duration_minutes, vet_id) SELECT 8, '2009-06-04', 'neutered', '14:30', 60, 3 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=3);
INSERT INTO visits (pet_id, visit_date, description, start_time, duration_minutes, vet_id) SELECT 7, '2008-09-04', 'spayed', '11:00', 45, 1 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=4);
...
INSERT INTO visits VALUES (default, 2, CURRENT_DATE + INTERVAL '3 days', 'annual checkup');
INSERT INTO visits VALUES (default, 3, CURRENT_DATE + INTERVAL '5 days', 'vaccination booster');
INSERT INTO visits VALUES (default, 4, CURRENT_DATE + INTERVAL '6 days', 'dental cleaning');
